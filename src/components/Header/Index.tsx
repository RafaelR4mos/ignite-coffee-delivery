...
import { ButtonCart, ButtonContainer, Counter, HeaderContainer, LocationContainer } from "./styles";
       ...
       <HeaderContainer>
            ...
            <ButtonContainer>
                ...
                <ButtonCart color="yellow-light" itemsNumber={1}>
                    ...
                    <Counter isShow={itemsAddedToCart ? true : false}>{itemsAddedToCart}</Counter>
                </ButtonCart>
            </ButtonContainer>
       </HeaderContainer>
    )
